...
# @Time    : 2025/9/7 14:32
# @Author  : caijian
# @File    : gemini-2.0-web-extractor.py
# @Software: PyCharm
import os
import json
import time
...
firecrawl_api_key = os.getenv("fc-d1f644e356c44793b56f66830bf199f6")
serp_api_key = os.getenv("380fe39f6919ee70af9cd1a3856dec84d3ba1d044603b0f79b242e7b2e851b9f")
...
def main():
    ...
    if data:
        ...
        print(
            f"{Colors.RED}Failed to extract the requested information. Try refining your prompt or choosing a different company.{Colors.RESET}")
