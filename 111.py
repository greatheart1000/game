...
gemini_api_key = os.getenv("AIzaSyCs1BQhboCv5kZm7RL6OBW18nXDQdKd57c")
...
def main():
    ...
    if map_website:
        print(
            f"{Colors.GREEN}Relevant pages identified. Proceeding with detailed analysis using gemini-pro...{Colors.RESET}")
